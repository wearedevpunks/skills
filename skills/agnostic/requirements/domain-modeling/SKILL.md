...
Pressure-test implementation and architecture consequences during live modeling. Persist accepted technical decisions in the grill artifacts and `SPEC.md`. Keep `GLOSSARY.md` glossary-only.

...
- `packages/auth/src/client/*`
- `packages/auth/src/server/*`
- `packages/forms/src/fields/*`

Bad package patterns:
- a giant `packages/ui/src/components` folder holding unrelated concerns
- `packages/shared/src/utils` growing without domain ownership
...
- `modules/auth/hooks`
- `modules/api/lib`
- `packages/auth/src/client/hooks`
- `packages/ui/src/brand/components`
